...
export const CAREERS: Career[] = [
  ...
  { n: "Odontología", v: { R: 0.7, I: 0.7, S: 0.6 }, d: "Cuidar la salud bucal combinando precisión manual, ciencia y atención al paciente.", f: ["Clínica dental", "Ortodoncia", "Cirugía oral"], u: ["unal", "javeriana", "bosque", "ces", "unicartagena", "unimetro", "unisinu", "uninorte", "sanmartin"], lvl: ["profesional"] },
